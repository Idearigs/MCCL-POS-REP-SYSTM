...
export class SalesController {
  ...
  @ApiQuery({ name: 'status', required: false, enum: ['PENDING', 'PROCESSING', 'COMPLETED', 'CANCELLED', 'REFUNDED', 'PARTIAL_REFUND'] })
  @ApiQuery({ name: 'paymentMethod', required: false, enum: ['CASH', 'CREDIT_CARD', 'DEBIT_CARD', 'BANK_TRANSFER', 'DIGITAL_WALLET', 'INSTALLMENT', 'LAYAWAY'] })
