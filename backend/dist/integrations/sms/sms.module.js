...
exports.SmsModule = SmsModule = __decorate([
    (0, common_1.Module)({
        providers: [sms_service_1.SmsService, sms_processor_service_1.SmsProcessorService],
        controllers: [sms_controller_1.SmsController],
        exports: [sms_service_1.SmsService, sms_processor_service_1.SmsProcessorService],
    })
], SmsModule);
